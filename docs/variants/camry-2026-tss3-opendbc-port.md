...
to this calibration. The exact producer is the EPS; the packet is an EPS telemetry/status
PDU with an application checksum inside an EPS-generated SecOC envelope. Deterministic
evidence is `tools/targets/camry/analysis/analyze_camry_f33_030_secoc_tx.py`,

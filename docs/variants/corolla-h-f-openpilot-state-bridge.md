...
`tools/extract_corolla_2023_public_route_opendbc_evidence.py` and
`tools/extract_span_2025_discord_rlog_opendbc_evidence.py`, with the common reduction in
`tools/toyota_route_opendbc_common.py`.

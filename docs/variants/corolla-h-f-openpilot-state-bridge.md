...
`0x08A` / `0x081` lateral request/reference family later recovered in detail on the
...
cross-generation interpretation is a persistent Toyota TSS3 **lateral
request/reference plane**, already present by the 2023 Corolla, rather than a
Camry-specific CAN convention.

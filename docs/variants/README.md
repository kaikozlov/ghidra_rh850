...
checks; Span's `8965F1208000`, `8965B4514000`, and the wider TSS 3.0 family keep
...
| Corolla (reported 2023 US / albinoelephant) | `8965H1202000` / `8A3111202000` from tracked CodeFlash live-ID blocks | Complete memory corpus retained; first foreign Gate/runtime resolver regression; queue `00F/D7/B6` has no `2E4/131`; direct UDS F181 transcript still absent | [corolla-2023-us-public-route.md](corolla-2023-us-public-route.md) |

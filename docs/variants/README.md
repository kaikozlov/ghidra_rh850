...
| Camry (maintainer 2026 specimen) | direct app F181 `8965F3307000` / `8A3113303100`; CodeFlash unavailable | Identity-bound bus1/param1 diagnostics + PROGRAMMING handoff + stationary READY CAN baseline retained; strong H/F wire-format continuity including dynamic `0x51E` Ready 0→1; firmware semantics/B6 sender remain bounded | [camry-2026-live-baseline.md](camry-2026-live-baseline.md) |

...
| Camry (maintainer 2026 specimen) | EPS F181 `8965F3307000` / `8A3113303100`; FRC `8646F3315000`; Brake/EPB `F152633K0000`; CodeFlash unavailable | Identity-bound bus1 diagnostics + EPS PROGRAMMING handoff + READY CAN baseline + NRTD FRC/Brake identities retained; controlled `0x51E` Ready 0→1, `0x0FE` cruise-button carrier, and full `0x127` P/R/N/D/B enum closed; B6/signing and Camry firmware semantics remain bounded | [camry-2026-live-baseline.md](camry-2026-live-baseline.md) |

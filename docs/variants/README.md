...
| Corolla (reported 2023 US / albinoelephant) | direct app F181 `8965F1208000` / `8A3111202000`; auxiliary DID2032 `8965H1202000` | Complete memory corpus + same-car eps-telescope probe retained; direct F181/MCU/live Gate-2/boot-RAM-exec joins verified; queue `00F/D7/B6` has no `2E4/131`; 2026-09-10 external field report demonstrates openpilot-longitudinal `0x160` transmission and lead following on stock Toyota-B | [corolla-2023-us-public-route.md](corolla-2023-us-public-route.md) · [Toyota TSS3 bounty evidence](toyota-tss3-openpilot-bounty-evidence.md) |

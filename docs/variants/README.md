...
| Camry (maintainer 2026 specimen) | EPS F181 `8965F3307000` / `8A3113303100`; exact 1-MiB CodeFlash SHA-256 `42dce8ef…d9b0e7`; FRC `8646F3315000`; Brake/EPB `F152633K0000` | Target-native B6/SecOC receiver, timing, limits, Ready/gear/cruise state and authenticated boot RAM path closed; `FEBFF9F0..FEBFFBFB` is live-proven retained/executable; application XCP can statically place arbitrary bytes there, while non-disruptive application-mode control transfer remains the signer-loader blocker | [camry-2026-live-baseline.md](camry-2026-live-baseline.md) |

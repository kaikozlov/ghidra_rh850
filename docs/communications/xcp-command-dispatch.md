...
window base are also pinned: a **zero-trip clear-shaped loop** at `0x1426`,
application page copy `0x6263E`, XCP range/translation helper `0x974D0`, and
XCP E4 copy `0x976D0`. At `0x1426` the start is `FEBF7C00` but the loop endpoint
is `FEBE7000`; the unsigned-lower branch therefore does not enter the store
body in this image (CORR-067).
...
b8fa3d951f59fb75c190ce1b2c73164adb952f871650cfcd3b7656f08a9c448d`): the
generic opcode map, all 18 callbacks, `0x7F7/0x7F8` packed descriptors,
...
- Findings with this document as canonical home: [COM-004](../reference/index.md#finding-com-004), [COM-005](../reference/index.md#finding-com-005), [COM-007](../reference/index.md#finding-com-007), [SEC-BOOT-012](../reference/index.md#finding-sec-boot-012), [VAR-041](../reference/index.md#finding-var-041)
- Corrections with this document as canonical home: [CORR-059](../reference/index.md#correction-corr-059), [CORR-060](../reference/index.md#correction-corr-060), [CORR-067](../reference/index.md#correction-corr-067)

...
| Exact cross-variant/target-generation transfers verified | 1 tracked foreign CodeFlash regression (`8965H1202000`) | The foreign Corolla image independently transfers the Gate-2 semantic/CRC resolver, all three crypto roots, boot-SA stage-1 shape, and callback-free runtime control discovery. Its actual Gate-2 queue is `00F/D7/B6`, so steering-bridge applicability correctly fails closed. `4514000`, Span's `8965F1208000`, and newer-TSK applicable targets remain artifact/evidence bounded |

...
| Findings dynamically/externally observed | 14 | Exact `observed...`-grade rows in `FINDINGS.md`: SECOC-030, VAR-001, STORE-007, VAR-108/109/110, TMS-086, VAR-116, VAR-124/125/126/128/129/133; observations are not promoted beyond their stated evidence boundary |

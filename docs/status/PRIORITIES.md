...
B28..B31 strongly match Toyota ordinary-P5 `FV4 || MAC28`; the downstream physical transmitter/proxy signer, private request handoff, signer key/profile selection, and actual grant remain open. CORR-135 rejects the old upstream-to-B6 inference; CORR-136 preserves the timing/source-attribution correction, while CORR-149 supersedes its former FRC-signer caveat.

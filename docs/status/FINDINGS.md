...
| ARCH-007 | Protected CAN `0x2E4` signal 61 (signed BE16 B1..B2; externally `STEER_TORQUE_CMD`) flows through `0xFEBE7F94 -> 0xFEBEF184 -> 0xFEBEAE20`, then clamp/gain `0xC853A` and saturation/rate-limit `0xC85B6` to `0xFEBEBF9A/0xFEBEBF84`; downstream current/PWM handoff remains unresolved | Sienna | recovered | `verify_control_partition.py`, `verify_external_corroboration.py` | [../architecture/control-partition.md](../architecture/control-partition.md) |

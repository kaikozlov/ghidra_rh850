...
- **Boundary:** no retained route contains a true MAIN-off transition, so the structural `CRUISE_MAIN_STATE` name is intentionally not promoted to an OEM diagnostic label. Existing set-speed and units conclusions are unchanged.

...
- **Separate 2023 US Corolla / tracked `8965H1202000` specimen.** The complete
  ...
  **316**, with zero unresolved `scheduler_system`, `can_com`, `storage_nvm`,
  `xcp`, `motor_control`, `secoc_icus`, `crypto`, `steering`, or `diagnostics` entries. All remaining named residue is untagged. Remaining H-static work is the explicit

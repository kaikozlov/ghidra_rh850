...
`09420f52…303b07`). A second tagged ASCII token `7E5` exists in the same row,
but its field meaning is not yet consumer-proven and is deliberately left
unlabeled. Legacy `SUW/InternalCF/Db/RpAppOsT.ini` FileVersion `17.0.13`

...
| `data/generated/corolla_8965H1202000_static_coverage_matrix.json` | Evidence-graded denominator over all 1,113 named canonical CodeFlash functions: exact transfer, inspected unique-shape, complete target-surface recensus, structural-only, or genuinely unresolved; H-only inspected additions counted separately | `tools/build_corolla_h_static_coverage_matrix.py` | `tests/verify_corolla_8965H1202000_static_coverage.py` regenerates exactly and enforces promotion discipline |

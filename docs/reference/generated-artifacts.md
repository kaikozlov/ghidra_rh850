...
| `data/semantic_coverage_ledger.csv` | Whole-image recovered-function ledger (5,858 rows) with evidence grades | `tools/generate_semantic_coverage_ledger.sh` (`make generate-semantic-coverage`) | `tests/verify_semantic_coverage.py` |

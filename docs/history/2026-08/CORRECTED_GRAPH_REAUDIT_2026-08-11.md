...
| SecOC writers, consumers, and dormant paths | `verify_secoc.py` | 189 |
...
| Diagnostic SID/RID/DID callbacks | `verify_application_diagnostics.py`, `verify_application_wdbi.py`, `verify_did_model.py` | 417 |
...
- Findings with this document as canonical home: [SWEEP-007](../../reference/index.md#finding-sweep-007)
- Corrections with this document as canonical home: [CORR-037](../../reference/index.md#correction-corr-037)

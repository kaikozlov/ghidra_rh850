...
| `BA` | proprietary operation table | `3` | direct `0x8D344` | ten selectors `F1,F3..FB`; F7/`BAENA` has callback-local SA2 gate and persists authorization state |
...
the proved d/q current/PWM cone.
...
### Proprietary `AB` event-record service / `BA` operation table
...
Its phase-0 path enters `0x8D2B2 -> 0x4C8A8 -> 0x348B4`, which dispatches ten
configured operations (`F1`, `F3`–`FB`) from the 16-byte descriptor table at
`0x28098`. Embedded request contracts are `JTEKM`, `TMPCL`, `JTRM1/2/3`,
`BADIS`, `BAENA`, `TZCLR`, `value || VSPD`, and `ASINC`. F7/`BAENA` is the
bootstrap: unlike the outer service object (`sec_count=0`), its callback has an
explicit application SecurityAccess-level-2 gate and persists a bounded BA
authorization marker/countdown. The other operations cover lifecycle requests,
persistent maintenance, a shared state workflow, and bounded operational
flags/overrides; the complete recovered cone remains outside the direct
conditioned-command/d/q/current-PI/PWM state set. See
[Application proprietary SID `0xBA`](application-proprietary-ba.md) and
`data/application_proprietary_ba_surface.csv`. It must not be used as evidence
about SID `0xAB`.
...
- Findings with this document as canonical home: [DIAG-APP-001](../reference/index.md#finding-diag-app-001), [DIAG-APP-002](../reference/index.md#finding-diag-app-002), [DIAG-APP-003](../reference/index.md#finding-diag-app-003), [DIAG-APP-004](../reference/index.md#finding-diag-app-004), [DIAG-APP-005](../reference/index.md#finding-diag-app-005), [DIAG-APP-006](../reference/index.md#finding-diag-app-006), [DIAG-APP-007](../reference/index.md#finding-diag-app-007), [DIAG-APP-008](../reference/index.md#finding-diag-app-008), [DIAG-APP-012](../reference/index.md#finding-diag-app-012), [DIAG-APP-013](../reference/index.md#finding-diag-app-013), [DIAG-APP-014](../reference/index.md#finding-diag-app-014), [DIAG-APP-015](../reference/index.md#finding-diag-app-015), [DIAG-APP-016](../reference/index.md#finding-diag-app-016), [DIAG-APP-017](../reference/index.md#finding-diag-app-017), [DIAG-APP-018](../reference/index.md#finding-diag-app-018), [DIAG-APP-019](../reference/index.md#finding-diag-app-019), [DIAG-APP-020](../reference/index.md#finding-diag-app-020), [DIAG-APP-023](../reference/index.md#finding-diag-app-023), [DIAG-APP-025](../reference/index.md#finding-diag-app-025), [MEM-SAFE-006](../reference/index.md#finding-mem-safe-006), [MEM-SAFE-007](../reference/index.md#finding-mem-safe-007)
- Corrections with this document as canonical home: [CORR-004](../reference/index.md#correction-corr-004), [CORR-014](../reference/index.md#correction-corr-014), [CORR-025](../reference/index.md#correction-corr-025), [CORR-026](../reference/index.md#correction-corr-026), [CORR-053](../reference/index.md#correction-corr-053), [CORR-055](../reference/index.md#correction-corr-055), [CORR-056](../reference/index.md#correction-corr-056), [CORR-057](../reference/index.md#correction-corr-057), [CORR-063](../reference/index.md#correction-corr-063)

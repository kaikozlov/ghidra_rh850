...
| [application-wdbi-surface.md](application-wdbi-surface.md) | Complete 19-entry application WDBI policy/selector/callback surface, recovered service-mode controls, and bounded motor-actuation separation |
...
- `data/application_wdbi_surface.csv` — per-DID WDBI policy, selector support,
  descriptor widths, callbacks, and bounded effect classification (generated by
  `tools/generate_application_wdbi_surface.py`).

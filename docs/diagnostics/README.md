...
- `data/application_diagnostic_map.csv` — per-SID application diagnostic
  ...
  (generated by `tools/firmware/generate_application_diagnostic_map.py`).
- `data/application_routine_control_surface.csv` — per-RID RoutineControl policy, control-type support, descriptor widths, callbacks, and bounded effect classification (generated by `tools/firmware/generate_application_routine_control_surface.py`).

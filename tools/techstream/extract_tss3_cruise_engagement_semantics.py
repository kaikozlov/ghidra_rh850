    ...
    out = {
        ...
        "frc_p5": {
            ...
            "boundary": (
                ...
                "The DDB rows alone do not establish their live diagnostic transport. Separate current-GTS+ host evidence now proves the selected "
                "0x1901/0x1905/0x1906/0x1912/0x1914 cruise Data IDs are issued as SID 0x22 ReadDataByIdentifier requests; CAN wire fields and any outer diagnostic-session prerequisite remain separate."
            ),
        },

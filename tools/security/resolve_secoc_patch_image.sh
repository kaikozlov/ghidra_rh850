...
usage() {
  cat <<'EOF'
Usage: tools/security/resolve_secoc_patch_image.sh CODEFLASH.bin [manifest.json]
...
from tools.security.build_secoc_patch_manifest import validate_codeflash_geometry

...
def main() -> int:
    ...
    with tempfile.TemporaryDirectory(prefix="semantic-sweep-inventory-", dir=REPO / "build" / "tmp") as tmp:
        ...
        exported = subprocess.run(
            [str(REPO / "tools/project/export_ghidra_project.sh"), "project-inventory", str(live_inventory)],
        ...
        compared = subprocess.run(
            [sys.executable, str(REPO / "tools/project/project_inventory.py"), "compare",

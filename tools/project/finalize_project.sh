#!/usr/bin/env bash
#
# tools/project/finalize_project.sh — orchestrate the full "end of session" lifecycle.
#
...
#
# Usage: tools/project/finalize_project.sh [--dry-run]
#
# Exit codes:
...
"$ROOT/tools/project/snapshot_project.sh" \

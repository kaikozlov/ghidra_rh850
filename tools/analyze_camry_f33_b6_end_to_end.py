...
FUNCTIONS = {
  ...
  0x0CB664: "B6 companion/readiness activation gate",
...
FIELD_MAP = [
  ...
  {"signal": 263, "wire": "B6[7]", "raw": "FEBE80CB", "stage": "FEBEF155", "snapshot": "FEBEADDD", "role": "activation companion; zero required by CB664"},
...
def analyze() -> dict[str, Any]:
  ...
  checks = {
    ...
    "sig263_zero_is_activation_condition": "DAT_febeaddd == '\\0'" in c[0xCB664] and "DAT_febeaddd != '\\0'" in c[0xCB664],
  ...
  gates = [
    ...
    {"order": 9, "layer": "B6 application companions/readiness", "site": "CB2A2/CB664/CDA20/CEC8A/CE3AA/CDFF8/CE7FE/CE836/...", "condition": "sig263=0 for activation; sig265=0 permits its term; application sequence is sane; sig269/270 percentages and local readiness/inhibits permit contribution", "failure_effect": "controller can remain unready, suppress a term, attenuate contribution, or ramp down without any SecOC failure", "stage5_bypasses": False, "live_witness": "ADDD/ADBB/ADBC/ADBD/ADBE + readiness state CAB*/CA*"},
  ...
  monitor_phases = [
    ...
    {
      "phase": "D",
      "purpose": "bank selection, B6 companion/readiness, and cooperative contribution",
      "watch_windows": [
        {"address": "0xFEBECAFC", "covers": ["CAFC/CAFD readiness", "CAFF route health"]},
        {"address": "0xFEBECB00", "covers": ["CB00 selected bank"]},
        {"address": "0xFEBEADBC", "covers": ["sig268 sequence", "sig269/270 percentages"]},
        {"address": "0xFEBEADDC", "covers": ["sig263 activation companion at ADDD"]},

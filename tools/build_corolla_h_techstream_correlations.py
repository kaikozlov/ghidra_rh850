...
def main() -> int:
    ...
    payload = {
        ...
        "static_conclusion": {
            ...
            "next_use": "Combine this sender/DTC evidence with the dedicated B6 target-angle and receiver-contract proofs. Profile labels, request selection, receiver-loss behavior in scheduler ticks, and sequence handling are closed there; the remaining software target is the upstream FRC_P5/Brake producer plus SecOC sender/freshness behavior.",
        },
    }

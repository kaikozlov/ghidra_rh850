...
SEMANTICS: dict[int, tuple[str, str]] = {
    ...
    0x1004: ("stateful_control", "selector 1 accepts a 2-byte input and reaches FUN_00050864; runtime preconditions apply"),
    0x1007: ("stateful_control", "selector 1 reaches thunk_B7A36(0); deeper OEM meaning unassigned"),
    0x1008: ("stateful_control", "selector 1 reaches direct_call_FDEA8; deeper OEM meaning unassigned"),

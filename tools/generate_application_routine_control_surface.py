...
SEMANTICS: dict[int, tuple[str, str]] = {
    ...
    0x1001: ("query_or_control", "control type 1 returns a 32-byte callback result; deeper OEM meaning unassigned"),
    0x1002: ("stateful_control", "control type 1 reaches FUN_00035582 then thunk_B7F7C(0x44); runtime preconditions apply"),
    0x1004: ("fixed_maintenance_trigger", "control type 1 requires fixed input FFFF then queues internal operation 5; tester value is not consumed by the action"),
    ...
    0x1103: ("stateful_control", "control type 1 reaches FUN_00035576; deeper OEM meaning unassigned"),
    0x1106: ("stateful_control", "control type 1 reaches thunk_B3974; runtime preconditions apply"),
    0x1108: ("stateful_control", "control type 1 reaches FUN_00050760; deeper OEM meaning unassigned"),
    0x1109: ("stateful_control", "control type 1 reaches thunk_B7D26(0x22,1); runtime preconditions apply"),

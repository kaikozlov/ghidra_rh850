...
ROOT=Path(__file__).resolve().parents[4];SRAW=SIENNA_CODEFLASH;HRAW=H_RAW_DUMP;OUT=ROOT/'data/generated/corolla_8965H1202000_application_interrupt_vectors.json';BASE=0x20200;COUNT=384

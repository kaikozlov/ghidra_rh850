...
shape consumed by :mod:`tools.targets.camry.analysis.analyze_camry_frc_lta_capture`, without retaining
...
e.g.::
  ...
  tools/targets/camry/extract/extract_camry_frc_lta_rlog.py build/tmp/camry-lta \

    ...
    manifest = {
        ...
        "ram_experiments": {
            "b6_inline_signer": {
                ...
                "operation": "post-startup helper load plus queue-source telemetry; local command-5 signing occurs only for a zero-trailer profile2 B6",
                ...
                "field_sequence": [
                    ...
                    "resume openpilot; ./f33-secoc status to inspect queue snapshot/signed_count",
                    "./f33-secoc quiet-source in READY/Park/stationary to measure profile2 activity with host B6 quiesced",
                ],

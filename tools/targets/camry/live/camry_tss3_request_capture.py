...
format used by :mod:`tools.targets.camry.live.camry_frc_lta_capture`, whose pandad ownership guard,
ELM327 safety configuration, and canbin plumbing are reused directly. The
companion analyzer is :mod:`tools.targets.camry.analysis.analyze_camry_tss3_request_capture`.
...
EXPECTED_SCHEMA = "toyota-diagnostics-registry-v6"
...
# tools/targets/camry/live/camry_frc_lta_capture.py already polls.
BRAKE_TX = 0x7B0
BRAKE_RX = 0x7B8
FRC_TX = 0x792
FRC_RX = 0x79A

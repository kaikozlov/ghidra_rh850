...
Input is the directory emitted by :mod:`tools.targets.camry.live.camry_tss3_request_capture`:
...
def main() -> int:
    ...
    ap.add_argument("capture_dir", type=Path, help="directory emitted by tools/targets/camry/live/camry_tss3_request_capture.py")

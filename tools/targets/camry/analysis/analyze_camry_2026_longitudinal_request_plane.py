...
from tools.targets.camry.analysis.analyze_camry_2026_lta_state_reconciliation import secoc_shape_stats
...
def build() -> dict:
  return {
    ...
    "interpretation": {
      ...
      "next_discriminator": "Run tools/targets/camry/live/camry_tss3_request_capture.py during stock DRCC and join FRC 0x792 DIDs 1B03..1B07 plus Brake 0x7B0 DIDs 10A1..10A4 to native bus1 0x160 and protected bus0/bus2 0x0CA.",
    },
  }

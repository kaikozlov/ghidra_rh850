...
public class SeedCrownF30Entries extends GhidraScript {
  ...
  @Override public void run() throws Exception {
    ensure(0x20880L,"crown_f30_application_entry");
    ensure(0x62BEEL,"crown_f30_startup_coordinator");
    ensure(0x62AD4L,"crown_f30_startup_copy_helper");
    ensure(0x709E4L,"crown_f30_application_context_init");
    println("SeedCrownF30Entries: seeded 4 exact Crown F30 application roots");
  }
}

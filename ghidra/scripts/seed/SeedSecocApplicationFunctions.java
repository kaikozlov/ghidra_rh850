...
public class SeedSecocApplicationFunctions extends GhidraScript {
    ...
    public void run() throws Exception {
        long[] entries={
            0x680F8L,0x68218L,0x682A6L,0x68B42L,0x69068L,0x69246L,0x6926AL,
            0x87A94L,0x87B46L,0x87BBAL,0x87C70L,0x87CCCL,0x87DD0L,
            0x87ED0L,0x88080L,0x880DCL,0x881DCL,

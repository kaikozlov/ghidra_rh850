...
public class SeedSecocApplicationFunctions extends GhidraScript {
    ...
    public void run() throws Exception {
        long[] entries={
            0x680F8L,0x68218L,0x6823CL,0x682A6L,0x6875EL,0x68B42L,0x68BC2L,0x68D0EL,
            0x68E16L,0x68EA8L,0x68F0CL,0x68F92L,0x68FC2L,0x69018L,0x69068L,
            0x6920AL,0x6922CL,0x69246L,0x6926AL,
            0x8A6C8L,0x8A860L,0x8A93CL,0x8AA1EL,0x8AB5AL,
            0x86E62L,0x86EE8L,0x8704CL,0x870A8L,0x871A0L,
            ...
            0x8F112L,0x8913CL,0x8917AL,0x892F2L,0x89360L,0x893B8L,
            0x893DEL,0x89424L,0x89448L,0x8949AL,0x894BEL,0x89510L,
            0x8954CL,0x89630L,0x897F4L,0x8997AL,
            0x955DCL,0x95624L,0x956C6L,0x95F82L,0x96354L,0x965CEL,0x96764L
        };

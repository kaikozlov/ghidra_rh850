...
public class SeedDispatchProvenFunctionTables extends GhidraScript {
    ...
    private static final Table[] TABLES = {
        new Table("application_command", 0x22c30L, 18, 4, new int[] {0},
            ...
            0x810eaL, 0x8114cL),
        new Table("application_routine_control_precondition", 0x25804L, 19, 12, new int[] {4},
            "bb72da6fb416c6fc47cb87cf2c060bb99f6bdb95499254bfbbfe960f1ccc979c",
            0x8d472L, 0x8d4b0L),
        new Table("application_routine_control_action", 0x25804L, 19, 12, new int[] {8},
            "bb72da6fb416c6fc47cb87cf2c060bb99f6bdb95499254bfbbfe960f1ccc979c",
            0x8d4ccL, 0x8d50aL),
        new Table("application_rdbi_callback", 0x2941cL, 242, 16, new int[] {4},
            "4b84c14b28e1518fae9a12de032b935503a22bda2c8797d330011d73ae848520",
            0x4cb8aL, 0x4cbb2L),

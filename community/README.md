...
## Maintainer-owned targets

Maintainer-operated vehicle evidence is not community provenance. The 2026 Camry
corpus formerly stored under `community/kai/camry-2026/` is now a first-class
project target under [`../targets/camry-2026/`](../targets/camry-2026/README.md),
with canonical firmware under `../firmware/camry-8965F3307000/`.
...
- Findings with this document as canonical home: [SECOC-028](../docs/reference/index.md#finding-secoc-028)
- Corrections with this document as canonical home: [CORR-087](../docs/reference/index.md#correction-corr-087)

...
with tempfile.TemporaryDirectory() as td:
    ...
    (fake_home / "Ghidra/application.properties").write_text("application.version=12.1.4\n")
    ext = temp / "extension"
    ...
    stale_text = env_template.read_text().replace('GHIDRA_VERSION="12.1.4"', 'GHIDRA_VERSION="12.1.3"')

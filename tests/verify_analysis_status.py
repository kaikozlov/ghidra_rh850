...
check("dynamic/external observation denominator", observed_findings == ["SECOC-030", "VAR-001", "STORE-007", "VAR-108", "VAR-109", "VAR-110", "TMS-086", "VAR-116", "VAR-124", "VAR-125", "VAR-126", "VAR-128", "VAR-129", "VAR-133", "VAR-135"])

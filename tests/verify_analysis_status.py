...
check("exact verified finding denominator", len(verified_findings) == 61)
check("dynamic observation denominator", observed_findings == ["SECOC-030", "VAR-001"])

required_tokens = [
    "113 `passed`, 5 `unavailable`, 0 `failed`",

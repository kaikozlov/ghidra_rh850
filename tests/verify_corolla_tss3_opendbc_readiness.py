...
check("normal CarState blocker narrows gear to enum transitions", any("P/R/N/B" in x and "0x127" in x for x in impl["blocks_normal_carstate"]) and any("Cruise availability" in x for x in impl["blocks_normal_carstate"]))

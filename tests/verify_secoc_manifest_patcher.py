...
check("bootstrap requires field-proven bootloader reappearance before SecurityAccess", "from tsk.lib.programming import enter_programming_bootloader, uds_client" in ram_exec_source and "expected_boot_f181_hex" in ram_exec_source and "programming handoff changed the preserved route" in ram_exec_source)

#!/usr/bin/env python3
"""Verify the tracked P1M-E product/address-space facts used by the Corolla audit."""
...
print("== exact R7F701383 product facts ==")
check("R7F701383 is tracked as DPS 1-MiB CodeFlash", prod["regulator"] == "DPS" and prod["codeflash_bytes"] == 0x100000)
check("R7F701383 DataFlash is 32 KiB", prod["dataflash_bytes"] == 0x8000)
check("R7F701383 local/global RAM totals are 128/64 KiB", prod["local_ram_bytes"] == 0x20000 and prod["global_ram_bytes"] == 0x10000)

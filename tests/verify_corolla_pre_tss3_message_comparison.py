...
check("B6 receiver request/loss/sequence rules are promoted", cmd["corolla_h_f"]["replacement"]["request_selection_closed"] is True and cmd["corolla_h_f"]["replacement"]["receiver_loss_cutout_ticks"] == 7 and cmd["corolla_h_f"]["replacement"]["wall_clock_timeout_closed"] is False and cmd["corolla_h_f"]["replacement"]["sequence_modulus"] == 64 and cmd["corolla_h_f"]["replacement"]["sequence_gap_cap"] == 8)

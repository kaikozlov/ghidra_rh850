...
check("comparison schema is v2", report["schema"] == "corolla-pre-tss3-opendbc-message-comparison-v2")
...
check("B6 command physical scale remains open", cmd["corolla_h_f"]["replacement"]["physical_scale_closed"] is False)

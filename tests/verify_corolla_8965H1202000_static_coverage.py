...
check('SecOC closure reduces overlapping crypto residue to seven',s['tag_coverage_counts']['crypto'].get('genuinely-unresolved')==7)
check('71 total roles are target-native recovered',s['coverage_counts'].get('target-native-role-recovered')==71)
check('global unresolved denominator is now 391',s['genuinely_unresolved_count']==391)

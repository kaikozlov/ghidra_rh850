...
check('122 total roles are target-native recovered',s['coverage_counts'].get('target-native-role-recovered')==122)
...
check('global unresolved denominator is now 217',s['genuinely_unresolved_count']==217)

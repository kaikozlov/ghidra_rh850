...
check('29 total roles are target-native recovered',s['coverage_counts'].get('target-native-role-recovered')==29)
check('two SecOC/NvM roles leave the SecOC residue at 42',s['tag_coverage_counts']['secoc_icus'].get('genuinely-unresolved')==42)
check('global unresolved denominator is now 433',s['genuinely_unresolved_count']==433)

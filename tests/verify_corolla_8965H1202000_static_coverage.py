...
check('all eight scheduler-system changed roles are target-native recovered',s['coverage_counts'].get('target-native-role-recovered')==8 and s['tag_coverage_counts']['scheduler_system'].get('genuinely-unresolved',0)==0)
check('global unresolved denominator is now 454',s['genuinely_unresolved_count']==454)

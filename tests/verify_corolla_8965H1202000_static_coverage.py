...
check('84 total roles are target-native recovered',s['coverage_counts'].get('target-native-role-recovered')==84)
check('global unresolved denominator is now 375',s['genuinely_unresolved_count']==375)

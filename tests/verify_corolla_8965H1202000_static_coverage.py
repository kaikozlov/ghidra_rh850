...
check('140 total roles are target-native recovered',s['coverage_counts'].get('target-native-role-recovered')==140)
...
check('global unresolved denominator is now 199',s['genuinely_unresolved_count']==199)

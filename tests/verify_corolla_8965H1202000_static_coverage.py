...
check('17 total roles are target-native recovered',s['coverage_counts'].get('target-native-role-recovered')==17)
check('global unresolved denominator is now 445',s['genuinely_unresolved_count']==445)

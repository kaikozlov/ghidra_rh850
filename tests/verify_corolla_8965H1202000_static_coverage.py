...
check('78 total roles are target-native recovered',s['coverage_counts'].get('target-native-role-recovered')==78)
check('global unresolved denominator is now 384',s['genuinely_unresolved_count']==384)

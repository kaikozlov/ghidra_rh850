...
TOP40 = [
    ...
    0xCB700, 0x6875E, 0xBA2B0, 0x50BEA, 0x33B08, 0x5B662, 0x5C56A, 0x3413A,
    0xFD562, 0xB8614, 0xB603A, 0x51C24, 0x68368, 0xC8AB0, 0x47C3C, 0x03B3C,
    0xBE804, 0x48312, 0x56F20, 0x67FCE, 0x90D9A, 0xC3A90, 0x32B80, 0x336CA,
]
MANDATED = {
...
def main() -> int:
    ...
    check("one row per semantic-ledger function", len(rows) == 6376, str(len(rows)))

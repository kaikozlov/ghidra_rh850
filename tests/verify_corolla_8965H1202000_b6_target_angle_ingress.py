...
print('\n== source identity ==')
check('schema v3',d['schema']=='corolla-8965H1202000-b6-target-angle-ingress-v3')
...
check('next target is request/cadence then upstream producer','request/validity/cadence/loss' in c['next_static_target'] and 'FRC_P5 -> Brake/EPB' in c['next_static_target'])

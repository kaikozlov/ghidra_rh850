...
out={"capture":"2026 Camry NRTD->READY + stationary gear sequence","duration_s":time.monotonic()-t0,"frames":frames}
raw=(json.dumps(out,separators=(",",":"))+"\n").encode()
with open("/cache/tsk/camry_ready_gear_20260826.json.gz","wb") as f:

...
while time.monotonic()<end:
    # drain Panda RX to prevent host USB backpressure; this does not transmit UDS
    s.panda.can_recv()
...
for i in range(10):
    s.panda.can_recv(); s.panda.can_send(CONTROL_CAN_ID,sf,CONTROL_CAN_BUS); time.sleep(.03)
time.sleep(.3)
